...
export default function HowItWorks2() {
  ...
  const handleContinue = () => {
    router.push(`/onboarding/how-it-works-3?nickname=${encodeURIComponent(nickname)}&avatar=${encodeURIComponent(avatar)}`);
  };
      ...
      <div className="max-w-md mx-auto">
        <header className="text-center mb-8">
          ...
          <div className="relative w-32 h-32 mx-auto mb-6 animate-bounce">
            ...
            Now that your money is safe, let’s give them a mission! Choose something you really want, like a toy, game, or book. This will be your savings goal, and we’ll stack your money until you reach it!
            </p>
          </div>
        </div>

        <div className="flex justify-between items-center">
          <div className="text-sm text-gray-500">2 of 3</div>
          <button
